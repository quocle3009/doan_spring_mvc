	...
	<div class="container">
		...
		<div class="form-layout">
			<form:form action="${pageContext.request.contextPath}/register"
				...
				<div class="form-group has-success">
					...
					<div class="col-xs-9">
						...
						<c:if test="${not empty update }">
							...
							<input name="oldUserId" hidden="true"
				...
				<div class="form-group has-success">
					<label class="col-xs-3 control-label" for="customerName">Name
						:</label>
					<div class="col-xs-9">
						<form:input path="customerName" class="form-control"
							placeholder="Enter Full Name" id="customerName" />
					</div>
				</div>
				<div class="row">
					<label class="col-xs-3 control-label" for="customerName"></label>
				...
				<div class="form-group has-success">
					<label class="col-xs-3 control-label" for="customerEmailAddress">Email
						Address :</label>
					<div class="col-xs-9">
						<form:input path="customerEmailAddress" class="form-control"
							placeholder="Enter Email Address" id="customerEmailAddress" />
					</div>
				</div>
				<div class="row">
					<label class="col-xs-3 control-label" for="customerName"></label>
				...
				<div class="form-group has-success">
					<label class="col-xs-3 control-label" for="custometPhoneNumber">Phone
						Number:</label>
					<div class="col-xs-9">
						<form:input path="custometPhoneNumber" class="form-control"
							placeholder="Enter Phone Number" id="custometPhoneNumber" />
					</div>
				</div>
				...
				<div class="row">
					<label class="col-xs-3 control-label" for="customerName"></label>
					<div class="col-xs-9">
						<form:errors path="billingAddress.strretName"
							cssStyle="color: #ff0000" />
					</div>
				</div>
				<div class="form-group has-success">
					<label class="col-xs-3 control-label"
						for="billingAddress.strretName">Street Name:</label>
					<div class="col-xs-9">
				...
				<div class="form-group has-success">
					<label class="col-xs-3 control-label"
						for="billingAddress.apartmentNumber">Apartment Number:</label>
					<div class="col-xs-9">
				...
				<div class="form-group has-success">
					...
					<div class="col-xs-9">
						<form:input path="billingAddress.city" class="form-control"
							placeholder="Enter City" id="billingAddress.city" />
					</div>
				</div>
				<div class="row">
					<label class="col-xs-3 control-label" for="customerName"></label>
				...
				<div class="form-group has-success">
					...
					<div class="col-xs-9">
						<form:input path="billingAddress.state" class="form-control"
							placeholder="Enter State" id="billingAddress.state" />
					</div>
				</div>
				<div class="row">
					<label class="col-xs-3 control-label" for="customerName"></label>
				...
				<div class="form-group has-success">
					...
					<div class="col-xs-9">
						<form:input path="billingAddress.country" class="form-control"
							placeholder="Enter Country" id="billingAddress.country" />
					</div>
				</div>
				<div class="row">
					<label class="col-xs-3 control-label" for="customerName"></label>
				...
				<div class="form-group has-success">
					<label class="col-xs-3 control-label" for="billingAddress.zipCode">Zip
						Code:</label>
					<div class="col-xs-9">

						<form:input path="billingAddress.zipCode" class="form-control"
							placeholder="Enter Zip Code" id="billingAddress.zipCode" />
					</div>
				</div>
				<div class="form-group has-success">
					<label class="col-xs-3 control-label"></label>
				...
				<div class="row">
					<label class="col-xs-3 control-label" for="customerName"></label>
					<div class="col-xs-9">
						<form:errors path="shippingAddress.strretName"
							cssStyle="color: #ff0000" />
					</div>
				</div>
				<div class="form-group has-success">
					<label class="col-xs-3 control-label"
						for="shippingAddress.strretName">Street Name:</label>
					<div class="col-xs-9">
				...
				<div class="form-group has-success">
					<label class="col-xs-3 control-label"
						for="shippingAddress.apartmentNumber">Apartment Number:</label>
					<div class="col-xs-9">
				...
				<div class="form-group has-success">
					...
					<div class="col-xs-9">
						<form:input path="shippingAddress.city" class="form-control"
							placeholder="Enter City" id="shippingAddress.city" />
					</div>
				</div>
				<div class="row">
					<label class="col-xs-3 control-label" for="customerName"></label>
				...
				<div class="form-group has-success">
					...
					<div class="col-xs-9">
						<form:input path="shippingAddress.state" class="form-control"
							placeholder="Enter State" id="shippingAddress.state" />
					</div>
				</div>
				<div class="row">
					<label class="col-xs-3 control-label" for="customerName"></label>
				...
				<div class="form-group has-success">
					...
					<div class="col-xs-9">
						<form:input path="shippingAddress.country" class="form-control"
							placeholder="Enter Country" id="shippingAddress.country" />
					</div>
				</div>
				<div class="row">
					<label class="col-xs-3 control-label" for="customerName"></label>
				...
				<div class="form-group has-success">
					<label class="col-xs-3 control-label" for="shippingAddress.zipCode">Zip
						Code:</label>
					<div class="col-xs-9">
						<form:input path="shippingAddress.zipCode" class="form-control"
							placeholder="Enter Zip Code" id="shippingAddress.zipCode" />
					</div>
				</div>
				<div class="form-group has-success">
					<label class="col-xs-3 control-label"></label>
